...
TP2Voyage: Trajet.o TrajetSimple.o TrajetCompose.o Parcours.o Catalogue.o main.o
	$(CC) $(OFLAGS)-o TPVoyage Trajet.o TrajetSimple.o TrajetCompose.o Parcours.o Catalogue.o main.o
